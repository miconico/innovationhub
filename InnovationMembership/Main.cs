...
namespace InnovationMembership
{
    public partial class Main : Form
    {
        ...
        private void paymentTypesToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            paymentTypes.ShowDialog(this);
        }

        private void searchPaymentsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            PaymentsSearch paymentsSearch = new PaymentsSearch();
            paymentsSearch.ShowDialog(this);
        }

        private void searchToolStripMenuItem_Click(object sender, EventArgs e)
        {
            InventorySearch inventorySearch = new InventorySearch();
            inventorySearch.ShowDialog(this);
        }

        private void bulkAddInventoryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            InventoryBulkAdd bulkAddInventory = new InventoryBulkAdd();
            bulkAddInventory.ShowDialog(this);
        }
        ...
        {
            Member makePortMember = new Member();
            makePortMember.ShowDialog();
